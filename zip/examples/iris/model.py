...
from mglearn.core import BaseModel, Dense
from mglearn.func.loss import CategoricalCrossEntropy
from mglearn.optim import SGD
from mglearn.func.activation import ReLU, Softmax, Tanh
import numpy as np
